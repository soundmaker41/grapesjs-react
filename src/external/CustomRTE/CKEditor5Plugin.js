/*
Copied entirely from https://github.com/GoodPHP/grapesjs-plugin-ckeditor5/blob/master/src/index.js
with minor modification to work in this example

TODO: Update this to add collaboration features of CKEditor5
*/
...
export default grapesjs.plugins.add('gjs-plugin-ckeditor5', (editor, opts = {}) => {
    ...
    editor.setCustomRte({
        enable: async (el, rte) => {
            ...
            modal.onceOpen(() => {
                window.ClassicEditor.create(document.querySelector(`#${el.id}ckeditor`), c.options)
                    .then(
                        editor => {
